...
- **`docs/spec/06-testing.md`'s marker-scope claim about `RUBRIC_V1` was asserted only in prose.** `JDG-U-028` asserts directly against `_INSTRUCTIONS` that it contains no `[[...]]`-shaped substring, rather than relying on no one ever adding one.
